module ActiveRecord
  ...
  # RakeMigrations can manage the evolution of a schema used by several physical databases. It's a solution
  ...
  #
  #   class AddSsl < ActiveRecord::RakeMigration
  #     def self.up
  ...
  #
  #   class AddSystemSettings < ActiveRecord::RakeMigration
  #     def self.up
  ...
  #
  # Some transformations are destructive in a manner that cannot be reversed. RakeMigrations of that kind should raise
  # an <tt>ActiveRecord::IrreversibleRakeMigration</tt> exception in their +down+ method.
  #
  ...
  #   script/generate migration MyNewRakeMigration
  #
  # where MyNewRakeMigration is the name of your migration. The generator will
  ...
  #   class AddFieldnameToTablename < ActiveRecord::RakeMigration
  #     def self.up
  ...
  # <tt>ActiveRecord::IrreversibleRakeMigration</tt> exception, that step will fail and you'll
  # have some manual work to do.
  #
  # == Database support
  #
  # RakeMigrations are currently supported in MySQL, PostgreSQL, SQLite,
  ...
  #
  #   class RemoveEmptyTags < ActiveRecord::RakeMigration
  #     def self.up
  ...
  #       raise ActiveRecord::IrreversibleRakeMigration, "Can't recover the deleted tags"
  #     end
  #   end
  #
  # Others remove columns when they migrate up instead of down:
  #
  #   class RemoveUnnecessaryItemAttributes < ActiveRecord::RakeMigration
  #     def self.up
  ...
  #
  #   class MakeJoinUnique < ActiveRecord::RakeMigration
  #     def self.up
  ...
  #
  #   class AddPeopleSalary < ActiveRecord::RakeMigration
  #     def self.up
  ...
  # long each step took.
  #
  # You can quiet them down by setting ActiveRecord::RakeMigration.verbose = false.
  #
